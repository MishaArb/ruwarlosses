...
class BBMLossChartScreen extends StatelessWidget {
  const BBMLossChartScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title:  Text(S.of(context).bbm, style: const TextStyle(color: Color.fromARGB(255, 235, 241, 235)),),
        elevation: 0.0,
